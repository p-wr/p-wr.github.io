...
bm=[0,[18,[1,[0,0,d(C)]],[2,0,[17,0,0]]],d(bb)],br=[0,d(bi),365,43],bQ=d(ba),bt=d(")"),bu=d(aB),bv=d(C),bw=d(C),bx=d(G),bO=d(ba),bP=d(bc),bz=d(C),bA=d(G),bB=d(aa),bD=d(bk),bE=d(aB),bF=d($),bG=d(G),bH=d(aa),bI=d(ai),bJ=d(ai),bK=d(bk),bL=d(aB),bM=d(ai),bN=d($),bC=d(bc),by=d(G),bV=d("div_pol1"),bW=[0,d(bi),477,16],bX=d(P),bY=d("x:"),bZ=d(P),b0=d("r:"),b1=d(P),b2=d("q:"),b3=d(P),b4=d("p:"),b5=d("div_pol:\n"),bT=d(P),bS=d("\n{ "),bU=d("}"),bR=[0,[18,[1,[0,0,d(C)]],[2,0,[17,0,0]]],d(bb)],bs=d(bg),bq=d("non"),bo=[0,0],bp=[0,1],cU=d(P),cT=d(C),cV=d("lp:\n"),cS=d("p: "),cR=d("homogeneous polynomials"),cW=d("computed"),cO=d("new polynomial: "),cN=d(be),cQ=d(bl),cP=d(G),cM=d("computation of the Groebner basis"),cL=d("coefficient: "),cK=d("verif sum: "),cJ=d("r: "),cG=d("remainder: "),cH=d("polynomial reduced to 0"),cI=d("r ok"),cE=[0,[12,91,[4,3,0,0,[12,44,[4,3,0,0,[12,93,0]]]]],d("[%i,%i]")],cD=[0,0,0],cA=d(" terms"),cB=d(" + "),cz=d(a$),cy=d(a$),cj=d(G),ck=d(aa),cl=d(ai),ce=d($),cf=d($),cg=d($),ch=d(aa),ci=d(C),cm=d("-1"),cn=d(G),co=d(aa),cr=d(bf),cs=d(C),ct=d(aA),cu=d("-"),cp=d("- "),cq=d(bf),cv=d(G),cw=d(C),cx=d(aA),cd=d(aA),cb=d(" i="),cc=d("lv= "),b$=d("]"),ca=d("["),b9=[0,0],b_=[0,1],cF=d("Nsatz_plugin.Ideal.Make(P).NotInIdealUpdate"),b6=d("Nsatz_plugin.Ideal.NotInIdeal"),dx=[0,d(_),243,9],d3=d("nsatz cannot solve this problem"),d1=d("core.eq.refl"),dZ=d(bd),dM=[0,[11,d("number of parameters: "),[4,3,0,0,0]],d("number of parameters: %i")],dJ=[0,[12,120,[4,3,0,0,0]],d("x%i")],dI=d("nsatz: bad parameter"),dQ=d("computation without sugar"),dR=d("computation with sugar"),dS=d("ordre lexico computation without sugar"),dT=d("ordre lexico computation with sugar"),dU=d("computation without sugar, division by pairs"),dV=d("computation with sugar, division by pairs"),dW=d("ordre lexico computation without sugar, division by pairs"),dX=d("ordre lexico computation with sugar, division by pairs"),dK=eb([d("a"),d("b"),d(be),d("d"),d("e"),d("f"),d("g"),d(bl),d("i"),d("j"),d("k"),d("l"),d("m"),d("n"),d("o"),d("p"),d("q"),d("r"),d("s"),d("t"),d(bg),d("v"),d("w"),d("x"),d("y"),d("z")]),dL=d("cert ok"),dN=d(bd),dO=[0,d(_),484,18],dP=[0,d(_),472,14],dH=[0,d(_),501,8],dG=[0,d(_),439,11],dF=[0,0,0],dE=[0,[11,d("time: "),[18,[1,[0,0,d(C)]],[8,0,[0,1,10],[0,3],[17,0,[12,115,0]]]]],d("time: @[%10.3f@]s")],dD=[0,[11,d("useful spolynomials: "),[4,3,0,0,[12,32,0]]],d("useful spolynomials: %i ")],dC=[0,[11,d("useless spolynomials: "),[4,3,0,0,0]],d("useless spolynomials: %i")],dz=[0,0,0],dA=[0,0,0],dB=d(G),dw=[0,0],c_=d("plugins.setoid_ring.pexpr"),c$=d("plugins.setoid_ring.const"),da=d("plugins.setoid_ring.var"),db=d("plugins.setoid_ring.add"),dc=d("plugins.setoid_ring.sub"),dd=d("plugins.setoid_ring.mul"),de=d("plugins.setoid_ring.opp"),df=d("plugins.setoid_ring.pow"),dg=d("core.list.type"),dh=d("core.list.nil"),di=d("core.list.cons"),dj=d("num.Z.type"),dk=d("num.Z.Z0"),dl=d("num.Z.Zpos"),dm=d("num.Z.Zneg"),dp=d("num.pos.xI"),dr=d("num.pos.xO"),ds=d("num.pos.xH"),dt=d("num.N.N0"),du=d("num.N.Npos"),d9=d(a_),d$=d(a_);function
